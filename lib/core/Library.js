...
export function createLibraryClasses(Library, LRUCache, _toNativeType, _toNativeTypes, native) {
  ...
  class CDLL {
    ...
    func(name, returnType, argTypes = [], options = {}) {
      ...
      if (argCount === 0) {
        asyncCallMethod = function () {
          return ffiFunc.callAsync();
        };
      } else if (allPrimitive) {
        switch (argCount) {
          case 1:
            asyncCallMethod = function (a0) {
              return ffiFunc.callAsync(a0);
            };
            break;
          case 2:
            asyncCallMethod = function (a0, a1) {
              return ffiFunc.callAsync(a0, a1);
            };
            break;
          case 3:
            asyncCallMethod = function (a0, a1, a2) {
              return ffiFunc.callAsync(a0, a1, a2);
            };
            break;
          case 4:
            asyncCallMethod = function (a0, a1, a2, a3) {
              return ffiFunc.callAsync(a0, a1, a2, a3);
            };
            break;
          default:
