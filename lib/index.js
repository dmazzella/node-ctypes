...
class Structure {
  ...
  getInt32Array(offset = 0, length) {
    return new Int32Array(this._buffer.buffer, this._buffer.byteOffset + offset, length);
  }

  getFloat64Array(offset = 0, length) {
    return new Float64Array(this._buffer.buffer, this._buffer.byteOffset + offset, length);
  }
      ...
      if (field) {
        ...
        if (field.isNested) {
          ...
          for (const subField of field.type.fields) {
            if (!subField.isAnonymous) {
            ...
            } else if (subField.isAnonymous && subField.type && subField.type.fields) {
              for (const subSubField of subField.type.fields) {
                Object.defineProperty(nestedInstance, subSubField.name, {
                  ...
                  set: (value) => field.type.set(nestedBuf, subSubField.name, value)
                });
              }
            }
          }
